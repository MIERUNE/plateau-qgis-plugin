...
2. 左のタブより[3Dビュー]を選択します。

3. 上部のプルダウンより[単一定義]を選択します。

4. [標高の制約]を[Z座標は標高の絶対値]を選択します。

5. OKをクリックして、プロパティを閉じます。

6. 画面右下の[EPSG]から始まるボタンをクリックして、プロジェクトの座標系をEPSG：3857などの投影座標系に変更します。

7. メニューバーの[ビュー]より、[3Dマップビュー]、[新規3Dマップビュー]の順に選択します。
