...
1.メニュータブの[プラグイン]から本プラグインを選択、またはプラグインツールバー上のアイコンを選択して本プラグインを起動。
